...
def _discover_plugins() -> None:
    ...
    try:
        import context_plugins  # noqa: F401
    except ModuleNotFoundError:
        _PLUGINS_DISCOVERED = True
        return

    # Import each module inside context_plugins so it can self-register.
    import context_plugins as _context_plugins

    for module in pkgutil.iter_modules(
        _context_plugins.__path__, prefix=_context_plugins.__name__ + "."
    ):

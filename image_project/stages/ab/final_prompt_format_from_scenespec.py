...
KIND_ID = "ab.final_prompt_format_from_scenespec"
...
def _build(_inputs: PlanInputs, *, instance_id: str, cfg: ConfigNamespace):
    def _prompt(ctx: RunContext) -> str:
        ...
        spec_json = require_text_output(ctx, "ab_scene_spec_json")
    ...
    cfg.assert_consumed()
    return make_chat_stage_block(instance_id, prompt=_prompt, temperature=0.55)

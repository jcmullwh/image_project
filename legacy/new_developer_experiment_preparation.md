...
- Stage registry (source of truth for stages): `image_project/stages/registry.py` (stage libraries under `image_project/stages/*`)
- Prompt policy helpers (prompt text templates): `image_project/prompts/*`
...
- Added A/B experiment stages under `image_project/stages/ab/*` (collected by `image_project/stages/registry.py`):

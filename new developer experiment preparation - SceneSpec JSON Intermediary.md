...
- `image_project/impl/current/prompting.py` (required): adds SceneSpec JSON intermediary stages and a “format-from-SceneSpec” final stage for the new A/B experiment.
